...
async function fn (client, msg, query) {
  await msg.channel.send('<a:__tri_loading:745878028093227118> 삭제중...')
  ...
  await msg.channel.bulkDelete(chmsgs)

  const dela = await msg.channel.send('<a:__tri_success:745878633624895599> ' + chmsgs.array().length + '개의 메세지를 삭제했어요')
